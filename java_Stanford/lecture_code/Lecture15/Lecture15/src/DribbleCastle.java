...
public class DribbleCastle extends GraphicsProgram {
	...
	private boolean hasHitSomethingElse(GOval dribble) {
		...
		// +1 because we need to check outside of the GOval itself!
		// Otherwise, getElementAt may return the dribble itself.
		double checkY = dribble.getY() + dribble.getHeight() + 1;
